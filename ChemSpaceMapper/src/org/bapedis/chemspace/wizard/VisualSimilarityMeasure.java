...
public final class VisualSimilarityMeasure extends JPanel {
    ...
    public VisualSimilarityMeasure() {
        initComponents();
        treeNode = new DefaultMutableTreeNode(NbBundle.getMessage(VisualSimilarityMeasure.class, "CSNVisualSimilarityMeasure.root.name"), true);
        populateJTree();
    ...
    public String getName() {
        return NbBundle.getMessage(VisualSimilarityMeasure.class, "CSNVisualSimilarityMeasure.name");
    }
