...
public class Brush implements Tool {
    ...
    private DiffusionMethods.DiffusionMethod diffusionMethod = DiffusionMethods.DiffusionMethod.NONE;
    ...
    private Node[] getDiffusedNodes(Node[] input) {
        GraphModel model = Lookup.getDefault().lookup(ProjectManager.class).getGraphModel();
...
//                }
    ...
    public ToolUI getUI() {
        return new ToolUI() {
            ...
            @Override
            public Icon getIcon() {
                return ImageUtilities.loadImageIcon("org/gephi/desktop/visualization/resources/brush.png", false);
            }
