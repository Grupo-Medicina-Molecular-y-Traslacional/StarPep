...
//        });
        ...
        if (projectManager.getCurrentWorkspace() != null) {
            model = projectManager.getCurrentWorkspace().getLookup().lookup(LayoutModelImpl.class);
            if (model == null) {
                model = new LayoutModelImpl(projectManager.getCurrentWorkspace());
            }
            projectManager.getCurrentWorkspace().add(model);
        }
    }
