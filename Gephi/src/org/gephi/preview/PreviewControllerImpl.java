...
public class PreviewControllerImpl implements PreviewController {
    ...
    public PreviewControllerImpl() {
        ...
        pc.addWorkspaceEventListener(new WorkspaceEventListener() {

            @Override
            public void workspaceChanged(Workspace oldWs, Workspace newWs) {
                model = newWs.getLookup().lookup(PreviewModelImpl.class);
                if (model == null) {
                    model = new PreviewModelImpl(newWs);
                    newWs.add(model);
                }
            }
        });
    ...
    public boolean sendMouseEvent(PreviewMouseEvent event) {
        return sendMouseEvent(event, Lookup.getDefault().lookup(ProjectManager.class).getCurrentWorkspace());
    }
