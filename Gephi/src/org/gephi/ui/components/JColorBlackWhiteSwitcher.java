...
public class JColorBlackWhiteSwitcher extends JButton {
    ...
    private void refreshIcon() {
        if (color.equals(Color.WHITE)) {//White color, show a lightbulb on:
            setIcon(ImageUtilities.loadImageIcon("org/gephi/desktop/visualization/resources/light-bulb.png", false));
        } else if (color.equals(Color.BLACK)) {//Black color, show a lightbulb off:
            setIcon(ImageUtilities.loadImageIcon("org/gephi/desktop/visualization/resources/light-bulb-off.png", false));
        } else {
