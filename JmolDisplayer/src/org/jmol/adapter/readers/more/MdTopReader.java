...
public class MdTopReader extends ForceFieldReader {
  ...
  protected void finalizeReader() throws Exception {
    ...
    Utilities.getIO().getOut().println("Total number of atoms used=" + nAtoms);
  ...
  01234567890123456789012345678901234567890123456789012345678901234567890123456789
    ...
    private void getPointers() throws Exception {
      ...
      if (isPeriodic) {
        Utilities.getIO().getOut().println("Periodic type: " + tokens[27]);
        htParams.put("isPeriodic", Boolean.TRUE);
      }
      Utilities.getIO().getOut().println("Total number of atoms read=" + atomCount);
...
%FORMAT(5E16.8)                                                                 
  ...
  private void getResiduePointers() throws Exception {
    ...
    Utilities.getIO().getOut().println("Total number of residues=" + resPtrs.length);
    int pt1 = atomCount;
    int pt2;
    Atom[] atoms = atomSetCollection.getAtoms();
