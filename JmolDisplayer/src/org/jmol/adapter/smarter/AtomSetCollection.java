/* $RCSfile$
 * $Author: hansonr $
 * $Date: 2011-12-01 23:48:47 +0100 (jeu., 01 déc. 2011) $
 * $Revision: 16543 $
 *
...
public class AtomSetCollection {
  ...
  public float[] setSuperCell(String supercell, float[] fmat) {
    ...
    if (isLocal) {
      fmatSuperCell = fmat;
      Utilities.getIO().getOut().println("Using supercell \n" + new Matrix4f(fmat));
    }
    return fmat;
  }
  ...
  public boolean setAtomSetCollectionPartialCharges(String auxKey) {
    ...
    Utilities.getIO().getOut().println("Setting partial charges type " + auxKey);
    return true;
  }
  ...
  */
  ...
  public void setAtomSetAtomProperty(String key, String data) {
    if (!data.endsWith("\n")) {
      data += "\n";
    }
