/* $RCSfile$
 * $Author: hansonr $
 * $Date: 2011-09-27 01:48:52 +0200 (mar., 27 sept. 2011) $
 * $Revision: 16130 $
 *
...
public class JmolFileDropper implements DropTargetListener {
  ...
  public void drop(DropTargetDropEvent dtde) {
    ...
    for (int i = 0; i < df.length; ++i) {
      ...
      Object o = null;
      if (true) {
        Utilities.getIO().getOut().println("df " + i + " flavor " + flavor);
        Utilities.getIO().getOut().println("  class: " + flavor.getRepresentationClass().getName());
        Utilities.getIO().getOut().println("  mime : " + flavor.getMimeType());
      }
