...
class IsoShapeReader extends VolumeDataReader {
  ...
  private void autoScaleOrbital() {
    ...
    Utilities.getIO().getOut().println("Atomic Orbital radial max = " + aoMax + " at " + rmax);
    Utilities.getIO().getOut().println("Atomic Orbital r2R2 max = " + aoMax2 + " at " + rmax2);
    ...
    if (monteCarloCount >= 0) {
      ...
      Utilities.getIO().getOut().println("Atomic Orbital phi^2theta^2 max = " + angMax2);
    ...
    Utilities.getIO().getOut().println("Atomic Orbital radial extent set to " + radius
  ...
  private void createMonteCarloOrbital() {
    ...
    if (params.distance == 0)
      Utilities.getIO().getOut().println("Atomic Orbital mean radius = " + rave / monteCarloCount
