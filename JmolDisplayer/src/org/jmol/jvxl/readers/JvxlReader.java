...
public class JvxlReader extends JvxlXmlReader {
  ...
  protected void readParameters() throws Exception {
    ...
    Utilities.getIO().getOut().println("Reading extra JVXL information line: " + line);
  ...
  protected void gotoData(int n, int nPoints) throws Exception {
    ...
    for (int i = 0; i < n; i++) {
      ...
      Utilities.getIO().getOut().println("JVXL skipping: jvxlSurfaceDataCount=" + surfaceDataCount
  ...
  private void jvxlReadDefinitionLine(boolean showMsg) throws Exception {
    ...
    if (showMsg)
      Utilities.getIO().getOut().println("reading jvxl data set: " + comment + line);
    ...
    if (param1 < 0 && param2 != -1) {
      ...
      if (nContoursRead == Integer.MIN_VALUE) {
        if (line.charAt(next[0]) == '[') {
           ...
           Utilities.getIO().getOut().println("JVXL read: contourColixes " + jvxlData.contourColors); 
        ...
        if (nContoursRead != 0 && params.nContours == 0) {
          ...
          Utilities.getIO().getOut().println("JVXL read: contours " + params.nContours);
        }
      }
    } else {
