/* $RCSfile$
 * $Author: hansonr $
 * $Date: 2011-09-20 22:53:47 +0200 (mar., 20 sept. 2011) $
 * $Revision: 16086 $
  ...
  public void createAtomDataSet(int tokType, Object atomSetCollection,
    ...
    for (JmolAdapter.AtomIterator iterAtom = adapter
      ...
      case Token.vibxyz:
        ...
        v.set(vx, vy, vz);
        if (Logger.debugging)
          Utilities.getIO().getOut().println("xyz: " + pt + " vib: " + v);
    ...
    case Token.vibxyz:
      ...
      Utilities.getIO().getOut().println("_vibrationName = " + vibName);
      viewer.setStringProperty("_vibrationName", vibName);
      break;
    case Token.xyz:
      Utilities.getIO().getOut().println(n + " atom positions read");
      recalculateLeadMidpointsAndWingVectors(-1);
      break;
    }    
  }
