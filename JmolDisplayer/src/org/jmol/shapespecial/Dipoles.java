...
public class Dipoles extends Shape {
  ...
  public void setProperty(String propertyName, Object value, BitSet bs) {
    ...
    if ("calculate" == propertyName) {
      ...
      Utilities.getIO().getOut().println("calculated molecular dipole = " + calculatedDipole + " "
    ...
    if ("thisID" == propertyName) {
      ...
      if (thisID.equals("molecular")) {
        ...
        if (v == null) {
          ...
          Utilities.getIO().getOut().println("file molecular dipole = " + v + " "
              + (v != null ? "" + v.length() : ""));
        }
        if (v == null)
...
//  @SuppressWarnings("unchecked")
  ...
  private void dumpDipoles(String msg) {
    ...
    if (currentDipole != null)
      Utilities.getIO().getOut().println(" current = " + currentDipole + currentDipole.origin);
    if (tempDipole != null)
      Utilities.getIO().getOut().println(" temp = " + tempDipole + " " + tempDipole.origin);
  }
