...
public class ActionManager {
  ...
  public void mouseAction(int action, long time, int x, int y, int count,
    ...
    if (!viewer.getMouseEnabled())
      return;
    //if (Logger.debugging)
      //Utilities.getIO().getOut().println("ActionManager mouseAction action=" + action + " x y = " + x + " " + y + " count = " + count + " mods = " + modifiers);
    switch (action) {
    case Binding.MOVED:
  ...
  private class TimeoutThread extends Thread {
    ...
    public void run() {
      ...
      //Utilities.getIO().getOut().println(toString());
...
//            System.out.println("timeout " + name + " not triggered " + this);
        ...
        Utilities.getIO().getOut().println("Timeout " + this + " interrupted");
      } catch (Exception ie) {
        Utilities.getIO().getOut().println("Timeout " + name + " Exception: " + ie);
      }
