...
//    private Action frontAction = new MoveToFrontAction();
...
//    private Action leftAction = new MoveToAction("left", "moveto 1.0 front;moveto 2.0 left");
    ...
    public static class MoveToTopAction implements ActionListener {
        ...
        public MoveToTopAction() {
            this.action = "moveto 1.0 front;moveto 2.0 top";
        }
        @Override
        public void actionPerformed(ActionEvent e) {
            if (viewer.getShowBbcage() || viewer.getBooleanProperty("showUnitCell")) {
    ...
    public static class MoveToBottomAction implements ActionListener {
        ...
        public MoveToBottomAction() {
            this.action = "moveto 1.0 front;moveto 2.0 bottom";
        }
        @Override
        public void actionPerformed(ActionEvent e) {
            if (viewer.getShowBbcage() || viewer.getBooleanProperty("showUnitCell")) {
    ...
    public static class MoveToRightAction implements ActionListener {
        ...
        public MoveToRightAction() {
            this.action = "moveto 1.0 front;moveto 2.0 right";
        }
        @Override
        public void actionPerformed(ActionEvent e) {
            if (viewer.getShowBbcage() || viewer.getBooleanProperty("showUnitCell")) {
    ...
    public static class MoveToLeftAction implements ActionListener {
        ...
        public MoveToLeftAction() {
            this.action = "moveto 1.0 front;moveto 2.0 left";
        }
        @Override
        public void actionPerformed(ActionEvent e) {
            if (viewer.getShowBbcage() || viewer.getBooleanProperty("showUnitCell")) {
