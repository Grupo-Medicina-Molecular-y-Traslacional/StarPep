/* $RCSfile$
 * $Author: hansonr $
 * $Date: 2011-12-22 14:32:44 +0100 (jeu., 22 déc. 2011) $
 * $Revision: 16625 $
 *
...
public class PreferencesDialog extends JDialog implements ActionListener {
    ...
    static boolean showMeasurements;
    static boolean perspectiveDepth;
    static boolean showAxes;
    static boolean showBoundingBox;
    static boolean axesOrientationRasmol;
    static boolean openFilePreview;
    static boolean clearHistory;
    static float minBondDistance;
    static float bondTolerance;
    static short marBond;
    static int percentVdwAtom;
    static JButton bButton, pButton, tButton, eButton, vButton;
    private static JRadioButton /*
             * pYes, pNo,
             */ abYes, abNo;
    private static JSlider vdwPercentSlider;
    private static JSlider bdSlider, bwSlider, btSlider;
    private static JCheckBox cH, cM;
    private static JCheckBox cbPerspectiveDepth;
    private static JCheckBox cbShowAxes, cbShowBoundingBox;
    private static JCheckBox cbAxesOrientationRasmol;
    private static JCheckBox cbOpenFilePreview;
    private static JCheckBox cbClearHistory;
    private static Properties originalSystemProperties;
    private static Properties jmolDefaultProperties;
...
//        updateComponents();
    ...
    public static class DispPanel extends JPanel {
    ...
    public static class AtomsPanel extends JPanel {
    ...
    private static Dictionary<Object, Object> getJSliderLabelTable(JSlider slider) {
        return slider.getLabelTable();
    }

    public static class BondPanel extends JPanel {
...
//        currentProperties.put("marBond", "" + marBond);
    ...
    static ItemListener checkBoxListener = new ItemListener() {
    ...
    @OptionsPanelController.SubRegistration(location = "JMol",
    position = 10,
    displayName = "Display",
    keywords = "Display",
    keywordsCategory = "JMol/Display")
    public static final class DisplayOptionsPanelController extends OptionsPanelController {
    ...
    displayName = "Atoms",
    keywords = "Atom",
    keywordsCategory = "JMol/Atom")
    public static final class AtomOptionsPanelController extends OptionsPanelController {
    ...
    displayName = "Bonds",
    keywords = "Bond",
    keywordsCategory = "JMol/Bond")
    public static final class BondOptionsPanelController extends OptionsPanelController {
