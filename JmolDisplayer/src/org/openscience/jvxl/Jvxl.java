...
public class Jvxl {
  ...
  public static void main(String[] args) {
    ...
    if (line.hasOption("p")) {
      ...
      Utilities.getIO().getOut().println("using plane " + plane);
      if (mapFile == null)
        mapFile = inputFile;
      if (inputFile == null)
        inputFile = mapFile;
    ...
    Utilities.getIO().getOut().println((String) sg.getProperty("jvxlFileInfo", 0));
...
class FileReader {
  ...
  private static Object getInputStreamOrErrorMessageFromName(String name) {
    ...
    try {
        Utilities.getIO().getOut().println("opening " + name);
